...
#                Given a blog with a name "What is Agile?" and vidauthor "Mark Shead" and url "https://www.youtube.com/watch?v=Z9QbYZh1YXY" is added
...
#                Given a blog with a name "What is Agile?" and vidauthor "Mark Shead" and url "https://www.youtube.com/watch?v=Z9QbYZh1YXY" is added
#		And the page of the new blog with the name "What is Agile?" is entered
